...
if not quota_filtered.empty:
    ...
    st.warning(f"⚠️ {len(quota_filtered)} farmers in the uploaded file have quota issues.")
else:
    st.success("✅ All farmers in the uploaded file are within their quotas.")
