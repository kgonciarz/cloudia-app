...
# Avoid duplicate keys by only using st.selectbox once
selected_language = st.sidebar.selectbox("Select Language", ["English", "Français"], index=0 if st.session_state.language == "en" else 1)
